...
public class ProductService {
    ...
    static {
        ...
        productList.add(new Product("PO262", "TV Stand", "Our TV stands and TV cabinets are there to cut the clutter and get things organized.", 69.99, 89.99, 120));
        ...
        productList.add(new Product("TF875", "Bezant Kitchen", "Express yourself in the place where all of life's daily activities take place.in our stylish, yet personalized kitchen..", 8900.00, 12200.99, 4));
    }
